...
import type { Comment } from '../apiTypes';
import {
  COMMENT_MAX_LENGTH,
  INITIAL_VISIBLE_COMMENTS_COUNT,
} from '../constants/article';

type UseArticleCommentsParams = {
  articleId: number;
};

export const useArticleComments = ({ articleId }: UseArticleCommentsParams) => {
  ...
  }, [articleId, loadComments, newComment]);
